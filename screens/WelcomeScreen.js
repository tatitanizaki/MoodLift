...
const WelcomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    const getRandomQuestions = () => {
      return {
        easy: vibeAnswers.easy[
          Math.floor(Math.random() * vibeAnswers.easy.length)
        ],
        medium:
          vibeAnswers.medium[
            Math.floor(Math.random() * vibeAnswers.medium.length)
          ],
        hard: vibeAnswers.hard[
          Math.floor(Math.random() * vibeAnswers.hard.length)
        ],
      };
    };
